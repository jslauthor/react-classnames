...
/***/ function(module, exports, __webpack_require__) {
	...
	var ClassnamesExample = function (_React$Component) {
	  _inherits(ClassnamesExample, _React$Component);

	  function ClassnamesExample(props) {
	    _classCallCheck(this, ClassnamesExample);

	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(ClassnamesExample).call(this, props));
	  ...
	  _createClass(ClassnamesExample, [{
	    key: 'render',
	    value: function render() {

	      var circleClasses = (0, _classnames2.default)({
	        circle: true,
	        off: !this.state.isOn,
	        on: this.state.isOn
	      });
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement('div', { className: circleClasses }),
	  ...
	  return ClassnamesExample;
	}(_react2.default.Component);

	exports.default = ClassnamesExample;


	window.onload = function () {
	  (0, _reactDom.render)(_react2.default.createElement(ClassnamesExample, null), document.getElementById('app'));
	};
